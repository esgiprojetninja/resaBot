    ...
    return [
        function (session, args) {
            if (args && args.reprompt) {
                ...
                builder.Prompts.choice(session, `Ok ${getUserName(session)}, which status of missions do you want to retrieve ?`, choices, {listStyle: builder.ListStyle["button"], maxRetries: 0});
            }
        },
        function (session, args) {
