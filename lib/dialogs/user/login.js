...
module.exports = [
    ...
    function (session, args) {
        ...
        let refreshingTypeNotif = setInterval(session.sendTyping, 1000);
        fetch(`${process.env.API_URL}/api/guard_code/check`, {
            ...
            if (res.hasError) {
                ...
                session.send("Wow, you just logged in ! Please wait a moment while we setup the connection with DevAway...");
